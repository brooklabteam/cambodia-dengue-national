...
# H0
out.cam.geno.rep.2019.uci = sim.SIR.age.three.clim.wane.intro(yrs=40,
                                              ntyr=26,
                                              s=101, 
...
save(out.cam.geno.rep.2019.uci, file = "cam-sim-geno-rep-2019-uci.Rdata")
...
# }
# 
# out.age <- summarise.age.dist(dat = out.cam.geno.rep.2019, year.start = min(out.cam.geno.rep.2007$year))
# 
#   
# #and plot cases
...
# }
# 
# plot.age.dist(df=out.age,slim.quant = 0.05, view.plot = T, save.plot=T, filename = "sim_intro_2019.png")

...
cam.sim = subset(cam.sim.infecteds, hyp=="0")


hyp0.fit.wane <- fit.wane.LBFGSB.all.three(dat.all = cam.sim,
                                           burnin=60,
                                           par.dat=hyp0.fit.lambda,
                                           sigma.guess = 1/50,
                                           sim_type="hyp0_wane", 
                                           perc.obs = 0.1,
                                           fit.CI=T)

save(hyp0.fit.wane, file = "hyp0-fit-wane.Rdata")

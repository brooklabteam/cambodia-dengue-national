...
load(paste0(homewd,"/figure-development/Fig5/sim-new/clean-sim/cam-sim-geno-no-wane.Rdata"))
...
load(paste0(homewd,"/figure-development/Fig5/sim-new/clean-sim/cam-sim-geno-rep-2007.Rdata"))
#load(paste0(homewd,"/figure-development/Fig5/sim-new/clean-sim/cam-sim-geno-rep-2007-lci.Rdata"))
#load(paste0(homewd,"/figure-development/Fig5/sim-new/clean-sim/cam-sim-geno-rep-2007-uci.Rdata"))
load(paste0(homewd,"/figure-development/Fig5/sim-new/clean-sim/cam-sim-geno-rep-2019.Rdata"))
#load(paste0(homewd,"/figure-development/Fig5/sim-new/clean-sim/cam-sim-geno-rep-2019-lci.Rdata"))
#load(paste0(homewd,"/figure-development/Fig5/sim-new/clean-sim/cam-sim-geno-rep-2019-uci.Rdata"))
...
select.symptom <- function(df, criteria){
  ...
  if(criteria=="Secondary+Reinfection"){
    ...
    df.perc <- cbind.data.frame(year=unique(df1.tert$year), perc_obs=seq(0,.03, length.out = length(unique(df$year))))
...
comp.dat.test <- rbind(age.sub.H0, age.sub.tert, age.sub.2019.b, age.sub.2019.c, age.sub.2019, age.sub.2007)
...
comp.dat.test$hyp <- factor(comp.dat.test$hyp, levels = c("H0: Normal Demographic\nSimulation", 
...
save(comp.dat.test, file = "comp-dat-sim-test-7-9.Rdata") 
...
save(comp.dat.lci, file = "comp-dat-sim-lci-7-9.Rdata") 
...
save(comp.dat.uci, file = "comp-dat-sim-uci-7-9.Rdata") 

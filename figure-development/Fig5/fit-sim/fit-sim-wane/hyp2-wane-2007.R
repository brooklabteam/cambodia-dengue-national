...
#setwd(paste0(homewd, "/figure-development/Fig5/fit-sim/fit-sim-wane/"))
#set wdset wd
...
hyp2.fit.wane.2007 <- fit.wane.LBFGSB.all.three(dat.all = cam.sim,
                                           burnin=20,
...
save(hyp2.fit.wane.2007, file = "hyp2-fit-wane-2007.Rdata")

...
#plot.cases.annual.triple.type(dat=out.cam.norm, year.start=1920, perc.obs=0.1, count.type = "secondary")
...
foi.up <- c(rep(.9,40),fit.dat$lci[fit.dat$provname=="National"])
...
#and in 2007
foi.up.2007 <- c(rep(.9,40),fit.dat$lci[fit.dat$provname=="National"])
...
cam.sim.lci <- rbind(out.cam.norm, out.cam.intro.3strains, out.cam.intro.maintain, out.cam.intro.maintain.mid, out.cam.intro.switch.wane, out.cam.intro.switch.wane.mid, out.cam.FOIup, out.cam.FOIupmid)
save(cam.sim.lci, file = "cam-sim-final-10-10-lci.Rdata")

...
out.cam.norm = sim.SIR.age.triple.num.intro.clim.maintain(yrs=80,
                                             ntyr=26,
                                             s=101, 
                                             foi=c(rep(.9,40),fit.dat$uci[fit.dat$provname=="National"]), 
...
foi.3strain.uci <- c(rep(.9,40),fit.dat$uci[fit.dat$provname=="National"])*2/3
...
foi.up <- c(rep(.9,40),fit.dat$uci[fit.dat$provname=="National"])
...
#and in 2007
foi.up.2007 <- c(rep(.9,40),fit.dat$uci[fit.dat$provname=="National"])
...
cam.sim.uci <- rbind(out.cam.norm, out.cam.intro.3strains, out.cam.intro.maintain, out.cam.intro.maintain.mid, out.cam.intro.switch.wane, out.cam.intro.switch.wane.mid, out.cam.FOIup, out.cam.FOIupmid)
save(cam.sim.uci, file = "cam-sim-final-10-10-uci.Rdata")

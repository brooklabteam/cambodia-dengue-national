...
fit.wane.LBFGSB.all.three <- function(dat.all,par.dat, burnin, sigma.guess, perc.obs, fit.CI, sim_type){
...
cam.sim = subset(cam.sim.infecteds, hyp=="2")


hyp2.fit.wane <- fit.wane.LBFGSB.all.three(dat.all = cam.sim,
                                           burnin=60,
                                           par.dat=hyp2.fit.lambda,
                                           sigma.guess = 1/50,
                                           sim_type="hyp2_wane", 
                                           perc.obs = 0.1,
                                           fit.CI=T)

save(hyp2.fit.wane, file = "hyp2-fit-wane.Rdata")

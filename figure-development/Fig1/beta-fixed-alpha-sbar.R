...
sim.com.epi <- function(time.start, dat, epiyr, family, alpha_incS, sbar_incS){
...
sim.return.S.incS <- function(fracincS,time.start, dat, epiyr, family, alpha_incS, sbar_incS){
  ...
  if(family=="poisson"){
    ...
    simfitted <- simulatetsir(data=subset(dat, time >= time.start & time<epiyr),
                              ...
                              #method='pois', 
                              nsim=100)
    saveRDS(fittedpars, file=paste0(homewd,"/", epiyr, "-beta-fittedpars-increaseS-gaussian-sim.return.S.incS.rds"))
...
fittedpars2007<-readRDS(paste0(homewd, "2007-fittedpars-increaseS-gaussian.rds"))
fittedpars2012<-readRDS(paste0(homewd, "2012-fittedpars-increaseS-gaussian.rds"))
fittedpars2019<-readRDS(paste0(homewd, "2019-fittedpars-increaseS-gaussian.rds"))

SepiInc2007<-readRDS(paste0(homewd, "2007-SepiInc-increaseS-gaussian.rds"))
SepiInc2012<-readRDS(paste0(homewd, "2012-SepiInc-increaseS-gaussian.rds"))
SepiInc2019<-readRDS(paste0(homewd, "2019-SepiInc-increaseS-gaussian.rds"))
...
sim.2007 <- sim.com.epi(dat = tsir.dat,
                        ...
                        family="gaussian",
                        epiyr = 2007,
                        alpha_incS=fittedpars2007$alpha, 
                        sbar_incS= as.numeric((fittedpars2007$sbar)/SepiInc2007))
...
sim.2012 <- sim.com.epi(dat = tsir.dat,
                        ...
                        family="gaussian",
                        epiyr = 2012,
                        alpha_incS=fittedpars2012$alpha, 
                        sbar_incS=as.numeric((fittedpars2012$sbar)/SepiInc2012))
...
sim.2019 <- sim.com.epi(dat = tsir.dat,
                        ...
                        family="gaussian",
                        epiyr = 2019,
                        alpha_incS=fittedpars2019$alpha, 
                        sbar_incS=as.numeric((fittedpars2019$sbar)/SepiInc2019))
...
ggsave(file =paste0(homewd,"/SusFig-draft-births-increasedS.png"),
       plot=p1,
       units=c("mm"),  
       width=80, 
       height=40, 
...
ggsave(file =paste0(homewd,"/SusFig-draft-time-increasedS.png"),
       plot=p2,
       units=c("mm"),  
       width=80, 
       height=40, 
...
#here, run fitted version with and without increased S
sim.with.increaseS <- function(fracincS,time.start, dat, epiyr, family, alpha_incS, sbar_incS){
...
p_tsir <- ggplot(data=dat, aes(x=time, y=reported_cases, color=variable, linetype=variable)) + 
...
ggsave(file = paste0(homewd, "/tsir.png"),
       plot=p_tsir,
       units=c("mm"),  
       width=250, 
       height=400, 

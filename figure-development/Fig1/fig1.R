# This file is for figure 1. There are 4 subplots to support the idea of two-strain
...
homewd = "/home/rstudio/"
# curr_dir<-"/2_fig2_tsir"
# homewd_curr= paste0(homewd,curr_dir)

load(paste0(homewd,"/data/TSdatCambodia.Rdata"))
load(paste0(homewd,"/data/cambodia_births_vector_2002_2020.Rdata"))
load(paste0(homewd,"/data/cambodia_pop_vector_2002_2020.Rdata"))

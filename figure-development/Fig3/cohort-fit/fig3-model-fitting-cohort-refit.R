...
# load the old fits and rerun with them
load(paste0(homewd,"figure-development/Fig3/cohort-fit/foi-kampong-speu-2019-cohort.Rdata"))


fit.KP.2019 <- fit.two.ts.all.yrs.BFGS(dat=dat.pos,
                                    par.dat = fit.KP.2019,
                                    lambda.guess=fit.KP.2019$lambda,
                                    N.sero.fix=2,
                                    fit.CI = T)
#now write data
save(fit.KP.2019, file = paste0(homewd,"figure-development/Fig3/cohort-fit/foi-kampong-speu-2019-cohort-refit.Rdata"))

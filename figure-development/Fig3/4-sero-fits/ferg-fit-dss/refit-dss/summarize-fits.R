...
setwd(paste0(homewd, "/figure-development/Fig3/4-sero-fits/ferg-fit-dss/refit-dss/out-refit-dss/"))
...
unique(fit.dat$convergence) 
unique(fit.dat$provname[fit.dat$convergence==1])#"Otdar Meanchey" "Preah Vihear"   "Svay Rieng"     "National"      

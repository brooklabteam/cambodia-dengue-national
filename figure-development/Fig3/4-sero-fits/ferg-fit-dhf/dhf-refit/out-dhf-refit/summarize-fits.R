...
setwd(paste0(homewd, "/figure-development/Fig3/4-sero-fits/ferg-fit-dhf/dhf-refit/out-dhf-refit/"))
...
unique(fit.dat$provname[fit.dat$convergence==1]) #"Kampong Chhnang" "Koh Kong"     "Ratanak Kiri"   
...
p2 <- ggplot(fit.dat) + 
  ...
  geom_vline(xintercept = 2012, linetype=2) +
  geom_vline(xintercept = 2019, linetype=2) +facet_wrap(~provname, ncol=4, scales = "free")

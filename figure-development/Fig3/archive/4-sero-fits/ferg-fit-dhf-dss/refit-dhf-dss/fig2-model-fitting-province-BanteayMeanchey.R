...
#setwd(homewd)
#setwd("/Users/carabrook/Developer/cambodia-dengue-national/figure-development/Fig3/4-sero-fits/ferg-fit-dss/refit-dss")
...
dat = subset(dat, diagnostic=="dhf" | diagnostic=="dss")
...
out <- fit.all.yrs.seq.yr.LBFGSB(dat=dat,
                               lambda.guess=fit.dat$lambda[fit.dat$provname=="Banteay Meanchey"],
                               N.sero.fix= 4,
                               fit.CI = TRUE)

...
#setwd(paste0(homewd, "/figure-development/Fig3/4-sero-fits/dss-add-ons/age-fit-dss/"))
...
age.fit.one <- fit.age.mult.LBFGSB.all(dat=dat,
                          par.dat=fit.dat,
                          fit.CI = TRUE)


save(age.fit.one, file = "fit-one-age-mult.Rdata")

...
setwd(paste0(homewd, "/figure-development/Fig3/4-sero-fits/dss-add-ons/wane-fit-all-time-dss/"))
...
p1 <- ggplot(sigma.fit) + geom_line(aes(x=year, y=sigma)) + 
                          ...
                          geom_point(aes(x=year, y=sigma)) +coord_cartesian(ylim=c(0,.00025))#+ scale_y_log10()
p1

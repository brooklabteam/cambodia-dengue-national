...
#setwd(paste0(homewd, "/figure-development/Fig3/4-sero-fits/ferg-fit-dhf/dhf-refit"))
...
out <- fit.all.yrs.seq.yr.LBFGSB(dat=dat,
                                 lambda.guess=fit.dat$lambda[fit.dat$provname=="National"],
                                 N.sero.fix= 4,
                                 fit.CI = TRUE)
out$provname = "national"


save(out, file = "fit-national.Rdata")

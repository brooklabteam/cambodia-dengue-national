...
refit.age.mult.LBFGSB.all <- function(dat,par.dat, age.mult, fit.CI){
...
age.refit.2 <- refit.age.mult.LBFGSB.all(dat=dat,
                          par.dat=fit.dat,
                          age.mult=age.refit,
                          fit.CI = TRUE)


save(age.refit.2, file = "refit-many-age-mult-2.Rdata")

...
setwd(paste0(homewd, "/figure-development/Fig3/age-fit-alt-two-short/"))

#load and combine the fits and plot them together (except not the ones with Inf)
#load("fit-all-provinces-age-mult.Rdata")
...
age.long <- melt(age.fit, id.vars = c("year_range", "age_mult", "lci_mult", "uci_mult"), measure.vars = c("age_min", "age_max"))

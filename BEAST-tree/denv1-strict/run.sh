#!/bin/bash
#SBATCH --job-name=onedenv1strict
...
/global/home/users/cbrook/beast/bin/beast -beagle_cpu -seed 777 -resume /global/scratch/users/cbrook/extend-dengue-one/denv1-strict/DENV1_beast_strict.xml

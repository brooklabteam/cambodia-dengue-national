#!/bin/bash
#SBATCH --job-name=onedenv2strict
...
/global/home/users/cbrook/beast/bin/beast -beagle_cpu -seed 777 -resume /global/scratch/users/cbrook/extend-dengue-one/denv2-strict/DENV2_beast_strict.xml
